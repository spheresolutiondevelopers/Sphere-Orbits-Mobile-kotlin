...
/**
 * Use case to generate a PDF report.
 */
class GeneratePdfReportUseCase @Inject constructor(
     ...
     * @return Result containing the PDF report as a string, or error
     */
    suspend operator fun invoke(startDate: String, endDate: String): Result<String> {
        ...
        return analyticsRepository.generatePdfReport(startDate, endDate)
    }
