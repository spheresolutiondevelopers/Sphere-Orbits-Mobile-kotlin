...
/**
 * Use case to generate a CSV report.
 */
class GenerateCsvReportUseCase @Inject constructor(
     ...
     * @return Result containing the CSV report as a string, or error
     */
    suspend operator fun invoke(startDate: String, endDate: String): Result<String> {
        ...
        return analyticsRepository.generateCsvReport(startDate, endDate)
    }
