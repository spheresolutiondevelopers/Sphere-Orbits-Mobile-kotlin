...
/**
 * Use case to sync calendar with external services.
 */
class SyncCalendarUseCase @Inject constructor(
    ...
    suspend fun syncWithGoogle(accessToken: String): Result<Unit> {
        ...
        return calendarRepository.syncWithGoogleCalendar(accessToken)
    }
    ...
    suspend fun syncWithOutlook(accessToken: String): Result<Unit> {
        ...
        return calendarRepository.syncWithOutlookCalendar(accessToken)
    }
