...
/**
 * Use case to send a message via WebSocket (real-time).
 */
class SendMessageViaWebSocketUseCase @Inject constructor(
    ...
    suspend operator fun invoke(
        ...
        return chatRepository.sendMessageViaWebSocket(message)
    }
